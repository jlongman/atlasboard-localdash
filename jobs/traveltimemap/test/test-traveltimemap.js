/**
 * Test file for Job: traveltimemap
 */

var assert = require ('assert');
var traveltimemap_SUT = require('../traveltimemap');

var mockedConfig, mockedDependencies;

describe ('traveltimemap test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      traveltimemap_SUT.onRun(config, mockedDependencies, function(err, data){
