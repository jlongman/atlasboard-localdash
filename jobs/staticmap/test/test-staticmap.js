/**
 * Test file for Job: staticmap
 */

var assert = require ('assert');
var staticmap_SUT = require('../staticmap');

var mockedConfig, mockedDependencies;

describe ('staticmap test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      staticmap_SUT.onRun(config, mockedDependencies, function(err, data){
